...
$(BC_OUT_DIR)/$(LOCAL_BUILDCONFIG_CLASS): FORCE
	...
	echo "    public static final int VERSION_CODE = "$(BC_VERSION_CODE)";" >> $(BC_OUT_DIR)/$(LOCAL_BUILDCONFIG_CLASS)
	echo "    public static final String VERSION_NAME = "\"$(BC_VERSION_NAME)"\";" >> $(BC_OUT_DIR)/$(LOCAL_BUILDCONFIG_CLASS)
